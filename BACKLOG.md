...
> **注意**：查看他人資料時需考慮 staleTime 策略。自己的資料可用長 staleTime（5 分鐘），但他人資料應使用短 staleTime（30 秒）或加上手動刷新按鈕，避免看到過期資料。建議建立獨立的 `useOtherUserRecords()` hook。
...
| 5 | 頁面切換效能優化：增加 staleTime、預取相鄰日/週資料（日切換、週切換） | 2026-01-09 | 已完成 |
